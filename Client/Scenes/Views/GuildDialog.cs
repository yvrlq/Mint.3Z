...
namespace Client.Scenes.Views
{
    public sealed class GuildDialog : DXWindow
    {
        ...
        public int TotalCost => (int) Math.Min(int.MaxValue, (GoldCheckBox.Checked ? CartoonGlobals.GuildCreationCost : 0) + (MemberLimit * CartoonGlobals.GuildMemberCost) + (StorageSize * CartoonGlobals.GuildStorageCost));

        public DXButton CreateButton, StarterGuildButton, GuildpaihangButton, GuildGerenpaihangButton, YunxujiaruGuildButton;

        public DXImageControl GuildpaihangIcon;
        ...
        public DXLabel MemberLimitLabel, GuildFundLabel, DailyGrowthLabel, TotalContributionLabel, DailyContributionLabel, GuildLevelLabel, GuildContributionLabel, JyTotalContributionLabel;
        ...
        public DXImageControl YiGongxiangIcon;
        public DXButton GerenGongxianButton, TuichuGuildButton;
        ...
        public GuildDialog()
        {
            ...
            SetClientSize(new Size(626, 419));
        ...
        private void ClearGuild()
        {
            ...
            HuodongTab.TabButton.Visible = GuildInfo != null;
            ...
            GuildLevelLabel.Text = string.Empty;
            GuildContributionLabel.Text = string.Empty;
        ...
        public void RefreshGuildDisplay()
        {
            ...
            GuildLevelLabel.Text = GameScene.Game.GuildBox.GuildInfo.GuildLevel.ToString("#,##0");

            decimal MaxContribution;

            MaxContribution = GameScene.Game.GuildBox.GuildInfo.GuildLevel < CartoonGlobals.GonghuiContributionList.Count ? CartoonGlobals.GonghuiContributionList[GameScene.Game.GuildBox.GuildInfo.GuildLevel] : 0;

            if (GameScene.Game.GuildBox.GuildInfo.GuildLevel < 15)
            {
                GuildContributionLabel.Text = $"{GameScene.Game.GuildBox.GuildInfo.JyTotalContribution:#,##0}" + " / " + $"{MaxContribution:#,##0}";
            }
            else
            {
                GuildContributionLabel.Text = "Max";
            }
        ...
        {
            StorageGrid.GridSize = new Size(17, Math.Max(20, (int)Math.Ceiling(GuildInfo.StorageLimit / (float)14)));
        ...
        public void PermissionChanged()
        {
            if (GuildInfo == null)
            {
                ...
                GameScene.Game.NPCYGoodsBox.GuildCheckBox.Enabled = false;
                GameScene.Game.NPCYGoodsBox.GuildCheckBox.Checked = false;
            ...
            GameScene.Game.NPCYGoodsBox.GuildCheckBox.Enabled = (GuildInfo.Permission & GuildPermission.Leader) == GuildPermission.Leader;
            ...
            if (!GameScene.Game.NPCYGoodsBox.GuildCheckBox.Enabled)
                GameScene.Game.NPCYGoodsBox.GuildCheckBox.Checked = false;
        ...
        public void CreateCreateTab()
        {
            ...
            {
                Label = { Text = $"{CartoonGlobals.GuildCreationCost:#,##0} Gold", ForeColour = Color.White },
                Parent = CreateTab,
                Checked = true,
                ReadOnly = true,
            };
            ...
            label = new DXLabel
            {
                ...
                IsControl = false,
                Hint = "基础限制: 10" +
                       $"每个成员位置的费用: {CartoonGlobals.GuildMemberCost}."
            };
            ...
            label = new DXLabel
            {
                ...
                IsControl = false,
                Hint = "基础存储: 10," +
                       $"每个存储空间成本: {CartoonGlobals.GuildStorageCost}."
            };
            ...
            YunxujiaruGuildButton = new DXButton
            {
                Parent = CreateTab,
                ButtonType = ButtonType.SmallButton,
            ...
            YunxujiaruGuildButton.MouseClick += (o, e) =>
            {
                CEnvir.Enqueue(new C.Chat { Text = "@允许加入公会" });
            };

            DXLabel labelb = new DXLabel
            {
                Text = "公会",
                Parent = CreateTab,
                Font = new Font(Config.FontName, CEnvir.FontSize(10F), FontStyle.Bold),
            ...
            labelb.Location = new Point(20, 275);

            GuildpaihangButton = new DXButton
            {
                Parent = CreateTab,
            ...
            GuildpaihangButton.MouseClick += (o, e) => GameScene.Game.GuildRankingBox.Visible = !GameScene.Game.GuildRankingBox.Visible;

            DXLabel labele = new DXLabel
            {
                Text = "贡献",
                Parent = CreateTab,
                Font = new Font(Config.FontName, CEnvir.FontSize(10F), FontStyle.Bold),
            ...
            labele.Location = new Point(80, 275);

            GuildGerenpaihangButton = new DXButton
            {
                Parent = CreateTab,
                LibraryFile = LibraryFile.GameInter,
                Index = 216,
            ...
            GuildGerenpaihangButton.MouseClick += (o, e) => GameScene.Game.GuildGerenBox.Visible = !GameScene.Game.GuildGerenBox.Visible;
        ...
        {
            GuildNameValid = CartoonGlobals.GuildNameRegex.IsMatch(GuildNameBox.TextBox.Text);
        ...
        private void CreateHomeTab()
        {
            ...
            NoticeTextBox = new DXTextBox
            {
                ...
                KeepFocus = false,
                Editable = false,
                MaxLength = CartoonGlobals.MaxGuildNoticeLength
            };
            ...
            */
            ...
            label.Location = new Point(325 - label.Size.Width, 5);

            GuildLevelLabel = new DXLabel
            {
                Parent = panel,
                Outline = true,
                Font = new Font(Config.FontName, CEnvir.FontSize(10F), FontStyle.Bold),
                ForeColour = Color.FromArgb(198, 166, 99),
                IsControl = false,
                Location = new Point(325, label.Location.Y),
            };

            YiGongxiangIcon = new DXImageControl
            {
                Parent = panel,
                LibraryFile = LibraryFile.GameInter,
                Index = 8036,
            ...
            YiGongxiangIcon.Location = new Point(35, 25);
            ...
            label.Location = new Point(170 - label.Size.Width, 30);

            GuildContributionLabel = new DXLabel
            {
                Parent = panel,
                Outline = true,
                ForeColour = Color.White,
                IsControl = false,
                Location = new Point(170, label.Location.Y),
            };
            ...
            label.Location = new Point(170 - label.Size.Width, 45);
            ...
            label.Location = new Point(170 - label.Size.Width, 60);
            ...
            GerenGongxianButton = new DXButton
            {
                Parent = panel,
                LibraryFile = LibraryFile.GameInter,
                Index = 6187,
                ...
                Hint = "玛法贡献排行榜",
                Location = new Point(577, 5),
            };
            GerenGongxianButton.MouseClick += (o, e) => GameScene.Game.GuildGerenBox.Visible = !GameScene.Game.GuildGerenBox.Visible;

            TuichuGuildButton = new DXButton
            {
                Parent = panel,
                LibraryFile = LibraryFile.GameInter,
                Index = 217,
                ...
                Hint = "退出公会",
                Location = new Point(577, 49),
            };
            TuichuGuildButton.MouseClick += (o, e) =>
            {
                DXMessageBox box = new DXMessageBox($"你确定要退出公会吗？", "确认", DXMessageBoxButtons.YesNo);

                box.YesButton.MouseClick += (o1, e1) =>
                {
                    CEnvir.Enqueue(new C.Chat { Text = "@退出公会" });
                };
            };
            ...
            label.Location = new Point(440 - label.Size.Width, 30);
            MemberLimitLabel = new DXLabel
            {
                ...
                ForeColour = Color.White,
                IsControl = false,
                Location = new Point(440, label.Location.Y),
            };
            ...
            label.Location = new Point(440 - label.Size.Width, 45);
            ...
            label.Location = new Point(440 - label.Size.Width, 60);
        ...
        public void CreateManageTab()
        {
            ...
            label.Location = new Point(ClientArea.X + 80 - label.Size.Width, 32);
            ...
            AddMemberTextBox = new DXTextBox
            {
                ...
                MaxLength = CartoonGlobals.MaxCharacterNameLength
            };
            ...
            {
                Parent = AddMemberPanel,
                Location = new Point(ClientArea.X + 195, label.Location.Y - 1),
                ButtonType = ButtonType.SmallButton,
                Size = new Size(60, SmallButtonHeight),
                Label = { Text = "邀请" },
            };
            ...
            {
                Parent = AddMemberPanel,
                Location = new Point(ClientArea.X + 80, label.Location.Y + 25),
                ButtonType = ButtonType.SmallButton,
                Size = new Size(110, SmallButtonHeight),
                Label = { Text = "默认排名" },
            };
            ...
            label = new DXLabel
            {
                Parent = TreasuryPanel,
                Text = "(百分率)",
                Location = new Point(ClientArea.X + 140, 32),
            };
            ...
            label.Location = new Point(ClientArea.X + 80 - label.Size.Width, 54);

            GuildFundLabel1 = new DXLabel
            {
                Parent = TreasuryPanel,
                Text = "10,000,000,000",
                Location = new Point(ClientArea.X + 77, label.Location.Y),
                ForeColour = Color.White,
            };
            ...
            label.Location = new Point(ClientArea.X + 80 - label.Size.Width, 35);

            IncreaseMemberButton = new DXButton
            {
                Parent = UpgradePanel,
                Location = new Point(ClientArea.X + 80, label.Location.Y - 1),
                ButtonType = ButtonType.SmallButton,
                Size = new Size(110, SmallButtonHeight),
                Label = { Text = $"升级 ({CartoonGlobals.GuildMemberCost:#,##0})" },
            };
            ...
            label1.Location = new Point(ClientArea.X + 230 - label1.Size.Width, label.Location.Y);

            MemberLimitLabel1 = new DXLabel
            {
                Parent = UpgradePanel,
                ForeColour = Color.White,
                Location = new Point(ClientArea.X + 230, label.Location.Y)
            };
            ...
            label.Location = new Point(ClientArea.X + 80 - label.Size.Width, 60);
            ...
            IncreaseStorageButton = new DXButton
            {
                ...
                ButtonType = ButtonType.SmallButton,
                Size = new Size(110, SmallButtonHeight),
                Label = { Text = $"升级 ({CartoonGlobals.GuildStorageCost:#,##0})" },
            };
            ...
            {
                Parent = GuildWarPanel,
                Text = $"成本: {CartoonGlobals.GuildWarCost:#,##0} 金币",
                Location = new Point(ClientArea.X + 80, label.Location.Y + 25),
            };
        ...
        {
            GuildWarNameValid = CartoonGlobals.GuildNameRegex.IsMatch(GuildWarTextBox.TextBox.Text);
        ...
        public DXLabel HuodongmingdanLabel, GuildBossHdrenshuLabel, GuildQuanLabel, GuildQuanrenshuLabel, GuildFubenLabel, GuildFubenrenshuLabel, GuildJiachengLabel, GuildJiachengrenshuLabel;
        public DXControl AddMemberPanels, GuildQuanPanels, GuildFubenPanels, GuildJiachengPanels;
        public void CreateHuodongTab()
        {
            HuodongTab = new DXTab
            {
                TabButton = { Label = { Text = "活动" } },
                Parent = GuildTabs,
                Border = true,
            };

            AddMemberPanels = new DXControl
            {
                Parent = HuodongTab,
                Location = new Point(5, 5),
                Size = new Size((HomeTab.Size.Width - 11 - 5) / 2, 83),
            ...
            {
                Text = "公会Boss活动",
                Parent = AddMemberPanels,
                Font = new Font(Config.FontName, CEnvir.FontSize(10F), FontStyle.Bold),
                ForeColour = Color.FromArgb(198, 166, 99),
                Outline = true,
                OutlineColour = Color.Black,
                IsControl = false,
                Size = new Size(AddMemberPanels.Size.Width, 22),
                DrawFormat = TextFormatFlags.HorizontalCenter | TextFormatFlags.VerticalCenter,
            };
            ...
            label.Location = new Point(110 - label.Size.Width, 33);

            HuodongmingdanLabel = new DXLabel
            {
                Parent = AddMemberPanels,
                Text = "没开启",
                Outline = true,
            ...
            label.Location = new Point(236 - label.Size.Width, 33);

            GuildBossHdrenshuLabel = new DXLabel
            {
                Parent = AddMemberPanels,
                Text = "0",
                Outline = true,
                ForeColour = Color.White,
                IsControl = false,
                Location = new Point(236, 33),
            };

            label = new DXLabel
            {
                Parent = AddMemberPanels,
                Text = "开启条件:公会等级6级，公会经费500万",
                ForeColour = Color.Gray,
            };
            label.Location = new Point(265 - label.Size.Width, 60);


            GuildQuanPanels = new DXControl
            {
                Parent = HuodongTab,
                Location = new Point(5, 93),
                Size = new Size((HomeTab.Size.Width - 11 - 5) / 2, 83),
            ...
            {
                Text = "公会泉活动",
                Parent = GuildQuanPanels,
                Font = new Font(Config.FontName, CEnvir.FontSize(10F), FontStyle.Bold),
                ForeColour = Color.FromArgb(198, 166, 99),
                Outline = true,
                OutlineColour = Color.Black,
                IsControl = false,
                Size = new Size(GuildQuanPanels.Size.Width, 22),
                DrawFormat = TextFormatFlags.HorizontalCenter | TextFormatFlags.VerticalCenter,
            };
            ...
            GuildQuanrenshuLabel = new DXLabel
            {
                Parent = GuildQuanPanels,
                Text = "0",
                Outline = true,
            ...
            {
                Parent = GuildQuanPanels,
                Text = "开启条件: 每天 04:00 至 23:00 自动开启",
                ForeColour = Color.Gray,
            };
            label.Location = new Point(265 - label.Size.Width, 60);


            GuildFubenPanels = new DXControl
            {
                Parent = HuodongTab,
                Location = new Point(5, 181),
                Size = new Size((HomeTab.Size.Width - 11 - 5) / 2, 83),
                Border = true,
                BorderColour = Color.FromArgb(198, 166, 99)
            };
            ...
            {
                Text = "公会副本活动",
                Parent = GuildFubenPanels,
                Font = new Font(Config.FontName, CEnvir.FontSize(10F), FontStyle.Bold),
                ForeColour = Color.FromArgb(198, 166, 99),
                Outline = true,
                OutlineColour = Color.Black,
                IsControl = false,
                Size = new Size(GuildFubenPanels.Size.Width, 22),
                DrawFormat = TextFormatFlags.HorizontalCenter | TextFormatFlags.VerticalCenter,
            };
            ...
            GuildFubenrenshuLabel = new DXLabel
            {
                Parent = GuildFubenPanels,
                Text = "0",
                Outline = true,
            ...
            {
                Parent = GuildFubenPanels,
                Text = "开启条件:公会等级6级，公会经费600万",
                ForeColour = Color.Gray,
            };
            label.Location = new Point(265 - label.Size.Width, 60);

            GuildJiachengPanels = new DXControl
            {
                Parent = HuodongTab,
                Location = new Point(5, 269),
                Size = new Size((HomeTab.Size.Width - 11 - 5) / 2, 83),
                Border = true,
                BorderColour = Color.FromArgb(198, 166, 99)
            };
            ...
            {
                Text = "公会加成活动",
                Parent = GuildJiachengPanels,
                Font = new Font(Config.FontName, CEnvir.FontSize(10F), FontStyle.Bold),
                ForeColour = Color.FromArgb(198, 166, 99),
                Outline = true,
                OutlineColour = Color.Black,
                IsControl = false,
                Size = new Size(GuildJiachengPanels.Size.Width, 22),
                DrawFormat = TextFormatFlags.HorizontalCenter | TextFormatFlags.VerticalCenter,
            };
            ...
            GuildJiachengLabel = new DXLabel
            {
                Parent = GuildJiachengPanels,
                Text = "没开启",
                Outline = true,
            ...
            GuildJiachengrenshuLabel = new DXLabel
            {
                Parent = GuildJiachengPanels,
                Text = "0",
                Outline = true,
            ...
            {
                Parent = GuildJiachengPanels,
                Text = "开启条件:公会等级9级，公会经费1000万",
                ForeColour = Color.Gray,
            };
            label.Location = new Point(268 - label.Size.Width, 60);
        }
        ...
        protected override void Dispose(bool disposing)
        {
            ...
            if (disposing)
            {
                ...
                {
                    if (!GuildLevelLabel.IsDisposed)
                        GuildLevelLabel.Dispose();

                    GuildLevelLabel = null;
                }


                if (GuildContributionLabel != null)
                {
                    if (!GuildContributionLabel.IsDisposed)
                        GuildContributionLabel.Dispose();

                    GuildContributionLabel = null;
                }
                ...
                if (JyTotalContributionLabel != null)
                {
                    if (!JyTotalContributionLabel.IsDisposed)
                        JyTotalContributionLabel.Dispose();

                    JyTotalContributionLabel = null;
                }
                ...
                if (AddMemberPanels != null)
                {
                    if (!AddMemberPanels.IsDisposed)
                        AddMemberPanels.Dispose();

                    AddMemberPanels = null;
                }
                
                if (HuodongmingdanLabel != null)
                {
                    if (!HuodongmingdanLabel.IsDisposed)
                        HuodongmingdanLabel.Dispose();

                    HuodongmingdanLabel = null;
                }

                if (GuildQuanPanels != null)
                {
                    if (!GuildQuanPanels.IsDisposed)
                        GuildQuanPanels.Dispose();

                    GuildQuanPanels = null;
                }

                if (GuildQuanrenshuLabel != null)
                {
                    if (!GuildQuanrenshuLabel.IsDisposed)
                        GuildQuanrenshuLabel.Dispose();

                    GuildQuanrenshuLabel = null;
                }
    ...
    public sealed class GuildMemberRow : DXControl
    {
        ...
        public DXLabel NameLabel, RankLabel, TotalLabel, DailyLabel, MapNameLabel, OnlineLabel;
        ...
        public void OnMemberInfoChanged(ClientGuildMemberInfo oValue, ClientGuildMemberInfo nValue)
        {
            ...
            MapNameLabel.Text = MemberInfo.MapName;
        ...
        public GuildMemberRow()
        {
            ...
            MapNameLabel = new DXLabel
            {
                IsControl = false,
                Parent = this,
                Location = new Point(500, 2),
                ForeColour = Color.White,
            };
        }
        ...
        public override void OnMouseClick(MouseEventArgs e)
        {
            ...
            switch (e.Button)
            {
                ...
                case MouseButtons.Right:
                    ...
                    GameScene.Game.BigMapBox.SelectedInfo = CartoonGlobals.MapInfoList.Binding.FirstOrDefault(x => x.Index == data.MapIndex);
                    break;
    ...
    public sealed class GuildMemberDialog : DXWindow
    {
        ...
        public GuildMemberDialog()
        {
            ...
            {
                DXMessageBox box = new DXMessageBox($"你确定要将 {MemberNameLabel.Text} 从公会中驱逐吗", "驱逐成员", DXMessageBoxButtons.YesNo);
    ...
    public sealed class GuildCastlePanel : DXControl
    {
        ...
        public void OnCastleChanged(CastleInfo oValue, CastleInfo nValue)
        {
            ...
            ItemLabel.Text = Castle.Item?.ItemName ?? "没有";
        }
        ...
        public GuildCastlePanel()
        {
            ...
            label.Location = new Point(105 - label.Size.Width, 25);
            ...
            label.Location = new Point(105 - label.Size.Width, 45);
            ...
            label.Location = new Point(105 - label.Size.Width, 95);
        ...
        public void Update()
        {
            ...
            CastleOwnerLabel.Text = string.IsNullOrEmpty(owner) ? "没有" : owner;
        }
