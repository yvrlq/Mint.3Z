        ...
        public void ResizeChat()
        {
            if (!IsResizing)
            {
                foreach (DXLabel label in History)
                {
                    ...
                    label.Size = new Size(size.Width, size.Height + 2);
        ...
        private void UpdateColours(DXLabel label)
        {
            ...
            switch ((MessageType)label.Tag)
            {
                case MessageType.Normal:
                    ...
                    break;
                case MessageType.Shout:
                    label.BackColour = Color.FromArgb(255, 255, 255, 0);
                ...
                case MessageType.Group:
                    ...
                    break;
                case MessageType.Global:
                    label.BackColour = Color.FromArgb(255, 0, 255, 0);
                ...
                case MessageType.Hint:
                    ...
                    break;
                case MessageType.System:
                    label.BackColour = Color.FromArgb(200, 255, 0, 0);
                    label.ForeColour = Config.SystemTextColour;
                    break;
                case MessageType.Announcement:
                    label.BackColour = Color.FromArgb(200, 148, 148, 255);
                ...
                case MessageType.WhisperOut:
                    ...
                    break;
                case MessageType.Combat:
                    label.BackColour = Color.FromArgb(200, 242, 131, 15);
                ...
                case MessageType.Notice:
                    label.BackColour = Color.FromArgb(200, (int)byte.MaxValue, (int)byte.MaxValue, (int)byte.MaxValue);
                    label.ForeColour = Config.NoticeTextColour;
                    break;
            }
