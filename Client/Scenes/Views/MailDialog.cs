...
namespace Client.Scenes.Views
{
    ...
    public sealed class ReadMailDialog : DXWindow
    {
        ...
        public ReadMailDialog()
        {
            ...
            DeleteButton.MouseClick += (o, e) =>
            {
                ...
                {
                    GameScene.Game.ReceiveChat("你不能删除有附带礼物的邮件", MessageType.System);
                    return;
                }
    ...
    public sealed class SendMailDialog : DXWindow
    {
        ...
        {
            GoldValid = GoldBox.Value >= 0 && GoldBox.Value <= MapObject.User.Gold && GoldBox.Value <= CartoonGlobals.MaxGold;
        ...
        {
            RecipientValid = CartoonGlobals.CharacterReg.IsMatch(RecipientBox.TextBox.Text);
