...
namespace Client.Scenes.Views
{
    public sealed class CharacterDialog : DXWindow
    {
        ...
        public DXLabel CharacterNameLabel, GuildNameLabel, GuildRankLabel, MarriageNameLabel, Shengwang, Jingyanshuaijian;
        ...
        public DXCheckBox ShowHelmetBox, ShowDunBox, ShowShizhuangBox;
        ...
        public CharacterDialog()
        {
            ...
            ShowShizhuangBox = new DXCheckBox
            {
                Parent = CharacterTab,
                Hint = "显示时装",
                ReadOnly = true,
            };
            ShowShizhuangBox.Location = new Point(306 - ShowShizhuangBox.Size.Width, 82 - ShowShizhuangBox.Size.Height);
            ShowShizhuangBox.MouseClick += (o, e) =>
            {
                CEnvir.Enqueue(new C.ShizhuangToggle { HideShizhuang = ShowShizhuangBox.Checked });
            };
            ...
            ShowHelmetBox.Location = new Point(306 - ShowHelmetBox.Size.Width, 99 - ShowHelmetBox.Size.Height);
            ShowHelmetBox.MouseClick += (o, e) =>
            {
                CEnvir.Enqueue(new C.HelmetToggle { HideHelmet = ShowHelmetBox.Checked });
            };

            ShowDunBox = new DXCheckBox
            {
                Parent = CharacterTab,
                Hint = "显示盾牌",
                ReadOnly = true,
            };
            ShowDunBox.Location = new Point(282 - ShowDunBox.Size.Width, 99 - ShowDunBox.Size.Height);
            ShowDunBox.MouseClick += (o, e) =>
            {
                CEnvir.Enqueue(new C.DunToggle { Dun = ShowDunBox.Checked });
            };
            ...
            DisplayStats[Stat.EWaiShanghaiG] = new DXLabel
            {
                Parent = StatsTab,
                Location = new Point(label.Location.X + label.Size.Width - 5, y),
                ForeColour = Color.White,
            ...
            DisplayStats[Stat.EWaiShanghaiW] = new DXLabel
            {
                Parent = StatsTab,
                Location = new Point(label.Location.X + label.Size.Width - 5, y),
                ForeColour = Color.White,
            ...
            DisplayStats[Stat.WupinBaolv] = new DXLabel
            {
                Parent = StatsTab,
                Location = new Point(label.Location.X + label.Size.Width - 5, y),
                ForeColour = Color.Aquamarine,
                Text = "0",
                Hint = "此属性已累计到“爆率加成”属性",
            };
            ...
            DisplayStats[Stat.JinbiBaolv] = new DXLabel
            {
                Parent = StatsTab,
                Location = new Point(label.Location.X + label.Size.Width - 5, y),
                ForeColour = Color.Aquamarine,
                Text = "0",
                Hint = "此属性已累计到“金币加成”属性",
            };
            ...
            but.MouseClick += (o, e) =>
            {
                ...
                if (check.Checked)
                {
                    DXMessageBox box = new DXMessageBox("确认增加你的防御?", "隐藏属性确认", DXMessageBoxButtons.YesNo);
            ...
            but.MouseClick += (o, e) =>
            {
                ...
                if (check.Checked)
                {
                    DXMessageBox box = new DXMessageBox("确认增加你的魔御?", "隐藏属性确认", DXMessageBoxButtons.YesNo);
            ...
            but.MouseClick += (o, e) =>
            {
                ...
                if (check.Checked)
                {
                    DXMessageBox box = new DXMessageBox("确认增加你的生命值?", "隐藏属性确认", DXMessageBoxButtons.YesNo);
            ...
            but.MouseClick += (o, e) =>
            {
                ...
                if (check.Checked)
                {
                    DXMessageBox box = new DXMessageBox("确认增加你的魔法值?", "隐藏属性确认", DXMessageBoxButtons.YesNo);
            ...
            but.MouseClick += (o, e) =>
            {
                ...
                if (check.Checked)
                {
                    DXMessageBox box = new DXMessageBox("确认增加你的破坏?", "隐藏属性确认", DXMessageBoxButtons.YesNo);
            ...
            but.MouseClick += (o, e) =>
            {
                ...
                if (check.Checked)
                {
                    DXMessageBox box = new DXMessageBox("确认增加你的自然?", "隐藏属性确认", DXMessageBoxButtons.YesNo);
            ...
            but.MouseClick += (o, e) =>
            {
                ...
                if (check.Checked)
                {
                    DXMessageBox box = new DXMessageBox("确认增加你的灵魂?", "隐藏属性确认", DXMessageBoxButtons.YesNo);
            ...
            but.MouseClick += (o, e) =>
            {
                ...
                if (check.Checked)
                {
                    DXMessageBox box = new DXMessageBox("确认增加你的火(火焰)攻击元素?", "隐藏属性确认", DXMessageBoxButtons.YesNo);

                    box.YesButton.MouseClick += (o1, e1) =>
                    {
                        CEnvir.Enqueue(new C.Hermit { Stat = Stat.FireAttack });
                    };
                }
                else
                {
            ...
            but.MouseClick += (o, e) =>
            {
                ...
                if (check.Checked)
                {
                    DXMessageBox box = new DXMessageBox("确认增加你的冰(冰寒)攻击元素?", "隐藏属性确认", DXMessageBoxButtons.YesNo);

                    box.YesButton.MouseClick += (o1, e1) =>
                    {
                        CEnvir.Enqueue(new C.Hermit { Stat = Stat.IceAttack });
                    };
                }
                else
                {
            ...
            but.MouseClick += (o, e) =>
            {
                ...
                if (check.Checked)
                {
                    DXMessageBox box = new DXMessageBox("确认增加你的雷(电击)攻击元素?", "隐藏属性确认", DXMessageBoxButtons.YesNo);

                    box.YesButton.MouseClick += (o1, e1) =>
                    {
                        CEnvir.Enqueue(new C.Hermit { Stat = Stat.LightningAttack });
                    };
                }
                else
                {
            ...
            but.MouseClick += (o, e) =>
            {
                ...
                if (check.Checked)
                {
                    DXMessageBox box = new DXMessageBox("确认增加你的风(风)攻击元素?", "隐藏属性确认", DXMessageBoxButtons.YesNo);

                    box.YesButton.MouseClick += (o1, e1) =>
                    {
                        CEnvir.Enqueue(new C.Hermit { Stat = Stat.WindAttack });
                    };
                }
                else
                {
            ...
            but.MouseClick += (o, e) =>
            {
                ...
                if (check.Checked)
                {
                    DXMessageBox box = new DXMessageBox("确认增加你的神圣(神圣)攻击元素?", "隐藏属性确认", DXMessageBoxButtons.YesNo);

                    box.YesButton.MouseClick += (o1, e1) =>
                    {
                        CEnvir.Enqueue(new C.Hermit { Stat = Stat.HolyAttack });
                    };
                }
                else
                {
            ...
            but.MouseClick += (o, e) =>
            {
                ...
                if (check.Checked)
                {
                    DXMessageBox box = new DXMessageBox("确认增加你的暗黑(暗黑)攻击元素?", "隐藏属性确认", DXMessageBoxButtons.YesNo);

                    box.YesButton.MouseClick += (o1, e1) =>
                    {
                        CEnvir.Enqueue(new C.Hermit { Stat = Stat.DarkAttack });
                    };
                }
                else
                {
            ...
            but.MouseClick += (o, e) =>
            {
                ...
                if (check.Checked)
                {
                    DXMessageBox box = new DXMessageBox("确认增加你的幻影(幻影)攻击元素?", "隐藏属性确认", DXMessageBoxButtons.YesNo);

                    box.YesButton.MouseClick += (o1, e1) =>
                    {
                        CEnvir.Enqueue(new C.Hermit { Stat = Stat.PhantomAttack });
                    };
                }
                else
                {
        ...
        private void CharacterTab_BeforeChildrenDraw(object sender, EventArgs e)
        {
            ...
            if (Grid[(int)EquipmentSlot.Armour].Item != null)
            {
                ...
                if (!ShowShizhuangBox.Checked || (Grid[(int)EquipmentSlot.Shizhuang].Item == null && ShowShizhuangBox.Checked))
                {
            ...
            {
                if (Grid[(int)EquipmentSlot.Shizhuang].Item != null && ShowShizhuangBox.Checked)
                {
                ...
                else if (Grid[(int)EquipmentSlot.Shizhuang].Item == null && !ShowShizhuangBox.Checked || Grid[(int)EquipmentSlot.Shizhuang].Item != null && !ShowShizhuangBox.Checked || Grid[(int)EquipmentSlot.Shizhuang].Item == null && ShowShizhuangBox.Checked)
                {
                    if (Grid[(int)EquipmentSlot.Armour].Item != null)
                    {
                        int index = Grid[(int)EquipmentSlot.Armour].Item.Info.Image;
            ...
            if (Grid[(int)EquipmentSlot.Shizhuang].Item == null && !ShowShizhuangBox.Checked && Grid[(int)EquipmentSlot.Helmet].Item != null && library != null && ShowHelmetBox.Checked ||
                Grid[(int)EquipmentSlot.Shizhuang].Item != null && !ShowShizhuangBox.Checked && Grid[(int)EquipmentSlot.Helmet].Item != null && library != null && ShowHelmetBox.Checked ||
                Grid[(int)EquipmentSlot.Shizhuang].Item == null && ShowShizhuangBox.Checked && Grid[(int)EquipmentSlot.Helmet].Item != null && library != null && ShowHelmetBox.Checked)
            {
        ...
        private void CharacterTab_SwChenghaoDraw(object sender, EventArgs e)
        {
            ...
            if (MapObject.User.Gerenshengwang > 0)
            {
                int index = GameScene.Game.User.Gerenshengwang;
