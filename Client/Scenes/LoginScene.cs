...
namespace Client.Scenes
{
    public class LoginScene : DXScene
    {
        ...
        public bool DianxinWangluo = false;
        public bool LiantongWangluo = false;
        ...
        public virtual void OnConnectionAttemptChanged(int oValue, int nValue)
        {
            ...
            string message = $"正在尝试连接到服务器.\n尝试:{ConnectionAttempt}";
            if (ConnectionBox == null)
            {
                ConnectionBox = new DXMessageBox(message, "连接", DXMessageBoxButtons.Cancel);
        ...
        public DXButton ConfigButton, RankingButton, GuildRankingButton;
        public DXConfigWindow ConfigBox;
        
        public DXWangluoWindow WangluoBox;
        ...
        public ContributionRankingDialog GuildRankingBox;
        
        public GuildGerenDialog GuildGerenBox;
        public DXImageControl Logo;
        ...
        public LoginScene(Size size) : base(size)
        {
            ...
            Logo = dxImageControl3;
            DXImageControl logo = Logo;
            Point point1 = new Point((Size.Width - Logo.Size.Width) / 2, 120);
            logo.Location = point1;
            ...
            WangluoBox = new DXWangluoWindow
            {
                Parent = this,
                Visible = true
            };
            WangluoBox.Location = new Point((Size.Width - WangluoBox.Size.Width) / 2, (Size.Height - WangluoBox.Size.Height) / 2);
            ...
            LoginBox.Location = new Point((Size.Width - LoginBox.Size.Width) / 2, (Size.Height - LoginBox.Size.Height) / 6 * 5);

            
            GuildRankingButton = new DXButton
            {
                LibraryFile = LibraryFile.GameInter,
                Index = 6187,
                Parent = this,
            ...
            GuildRankingButton.Location = new Point(Size.Width - GuildRankingButton.Size.Width - 50, 10);
            GuildRankingButton.MouseClick += (o, e) => GuildRankingBox.Visible = !GuildRankingBox.Visible;

            
            GuildRankingBox = new ContributionRankingDialog
            {
                Parent = this,
                Visible = false,
            };
            GuildRankingBox.Location = new Point((LoginBox.Location.X - GuildRankingBox.Size.Width) / 2, (Size.Height - GuildRankingBox.Size.Height) / 2);
            ...
            RankingButton.Location = new Point(Size.Width - RankingButton.Size.Width - 90, 10);
            RankingButton.MouseClick += (o, e) => RankingBox.Visible = !RankingBox.Visible;
            ...
            if (DianxinWangluo)
            {
                if (!CEnvir.Loaded)
                {
                    ...
                    ConnectionBox = new DXMessageBox("加载客户端信息...\n" +
                                                     "请稍等...", "加载中", DXMessageBoxButtons.Cancel);
        ...
        public sealed class LoginDialog : DXWindow
        {
            ...
            public DXImageControl LoginImage;
            public DXImageControl NewAccountImage;
            public DXImageControl ChangePasswordImage;
            public DXLabel TipsLabel;
            public DXButton QuitButton;
            ...
            public LoginDialog()
            {
                ...
                dxImageControl.LibraryFile = LibraryFile.Interface1c;
                dxImageControl.Index = 2;
                dxImageControl.Location = new Point(0, 0);
                LoginImage = dxImageControl;
                ...
                dxLabel1.Location = new Point(320, 39);
                dxLabel1.Text = "请输入你的邮箱账号和密码";
                dxLabel1.ForeColour = Color.Gainsboro;
                TipsLabel = dxLabel1;
                ...
                EMailHelpLabel = new DXLabel
                {
                    ...
                    Parent = this,
                    Text = "[?]",
                    Hint = $"E-Mail 地址.\n格式: Example@Example.Com.\n最大长度: {CartoonGlobals.MaxEMailLength} 字符.",
                };
                ...
                PasswordHelpLabel = new DXLabel
                {
                    ...
                    Parent = this,
                    Text = "[?]",
                    Hint = $"密码.\n允许非空格字符.\n长度: 处于 {CartoonGlobals.MinPasswordLength} 和 {CartoonGlobals.MaxPasswordLength} 之间.",
                };
                ...
                RememberCheckBox.Location = new Point(PasswordTextBox.Location.X + PasswordTextBox.Size.Width - RememberCheckBox.Size.Width + 80, 39);
                ...
                dxButton2.Location = new Point(665, 60);
                dxButton2.Size = new Size(100, DXControl.DefaultHeight);
                dxButton2.Label.Text = "退出";
                QuitButton = dxButton2;
                QuitButton.MouseClick += (o, e) => CEnvir.Target.Close();

                DXButton dxButton3 = new DXButton();
                dxButton3.Parent = this;
                dxButton3.LibraryFile = LibraryFile.Interface1c;
                dxButton3.Index = 11;
                dxButton3.Location = new Point(643, 0);
                dxButton3.Size = new Size(150, DefaultHeight);
                ChangePasswordImage = (DXImageControl)dxButton3;
                ChangePasswordImage.MouseClick += new EventHandler<MouseEventArgs>(ChangePasswordImage_MouseClick);
                ...
                ForgotPasswordLabel.Location = new Point(650, 39);
                ForgotPasswordLabel.MouseClick += ForgotPasswordLabel_MouseClick;

                DXButton dxButton4 = new DXButton();
                dxButton4.Parent = this;
                dxButton4.LibraryFile = LibraryFile.Interface1c;
                dxButton4.Index = 10;
                dxButton4.Location = new Point(505, 0);
                dxButton4.Size = new Size(150, DefaultHeight);
                NewAccountImage = dxButton4;
                NewAccountImage.MouseClick += new EventHandler<MouseEventArgs>(NewAccountImage_MouseClick);
            ...
            private void EMailTextBox_TextChanged(object sender, EventArgs e)
            {
                ...
                EMailValid = !string.IsNullOrEmpty(EMailTextBox.TextBox.Text) && EMailTextBox.TextBox.Text.Length >= 2;
            ...
            {
                PasswordValid = !string.IsNullOrEmpty(PasswordTextBox.TextBox.Text) && CartoonGlobals.PasswordRegex.IsMatch(PasswordTextBox.TextBox.Text);
            ...
            private void ChangePasswordImage_MouseClick(object sender, MouseEventArgs e)
            {
                LoginScene scene = ActiveScene as LoginScene;
                if (scene == null)
                    return;
            ...
            private void NewAccountImage_MouseClick(object sender, MouseEventArgs e)
            {
                LoginScene scene = ActiveScene as LoginScene;
                if (scene == null)
                    return;
            ...
            protected override void Dispose(bool disposing)
            {
                ...
                if (disposing)
                {
                    ...
                    if (NewAccountImage != null)
                    {
                        if (!NewAccountImage.IsDisposed)
                            NewAccountImage.Dispose();
                        NewAccountImage = null;
                    }

                    if (ChangePasswordImage != null)
                    {
                        if (!ChangePasswordImage.IsDisposed)
                            ChangePasswordImage.Dispose();
                        ChangePasswordImage = null;
                    }
        ...
        public sealed class NewAccountDialog : DXWindow
        {
            ...
            public NewAccountDialog()
            {
                ...
                EMailTextBox = new DXTextBox
                {
                    ...
                    MaxLength = CartoonGlobals.MaxEMailLength,
                    Parent = this,
                ...
                Password1TextBox = new DXTextBox
                {
                    ...
                    MaxLength = CartoonGlobals.MaxPasswordLength,
                    Parent = this,
                    Password = true,
                ...
                RealNameTextBox = new DXTextBox
                {
                    ...
                    MaxLength = CartoonGlobals.MaxRealNameLength,
                    Parent = this,
                    Size = new Size(136, 20),
                };
                ...
                RealNameHelpLabel = new DXLabel
                {
                    ...
                    Parent = this,
                    Text = "[?]",
                    Hint = $"真实名字.\n允许所有字符串.\n长度: 处于 {CartoonGlobals.MinRealNameLength} 和 {CartoonGlobals.MaxRealNameLength} 之间.\n要求: {CartoonGlobals.RealNameRequired}",
                };
                ...
                RealNameValid = !CartoonGlobals.RealNameRequired;
                BirthDateValid = !CartoonGlobals.BirthDateRequired;
                ReferralValid = true;
            }
            ...
            private void EMailTextBox_TextChanged(object sender, EventArgs e)
            {
                EMailValid = CartoonGlobals.EMailRegex.IsMatch(EMailTextBox.TextBox.Text) && EMailTextBox.TextBox.Text.Length <= CartoonGlobals.MaxEMailLength;
            ...
            {
                Password1Valid = !string.IsNullOrEmpty(Password1TextBox.TextBox.Text) && CartoonGlobals.PasswordRegex.IsMatch(Password1TextBox.TextBox.Text);
            ...
            {
                RealNameValid = (!CartoonGlobals.RealNameRequired && string.IsNullOrEmpty(RealNameTextBox.TextBox.Text)) ||
                                (RealNameTextBox.TextBox.Text.Length >= CartoonGlobals.MinRealNameLength && RealNameTextBox.TextBox.Text.Length <= CartoonGlobals.MaxRealNameLength);
            ...
            {
                DateTime temp;
                BirthDateValid = (!CartoonGlobals.BirthDateRequired && string.IsNullOrEmpty(BirthDateTextBox.TextBox.Text)) || DateTime.TryParse(BirthDateTextBox.TextBox.Text, out temp);

                if (!CartoonGlobals.BirthDateRequired && string.IsNullOrEmpty(BirthDateTextBox.TextBox.Text))
            ...
            {
                ReferralValid = string.IsNullOrEmpty(ReferralTextBox.TextBox.Text) || (CartoonGlobals.EMailRegex.IsMatch(ReferralTextBox.TextBox.Text) && ReferralTextBox.TextBox.Text.Length <= CartoonGlobals.MaxEMailLength);
        ...
        public sealed class ChangePasswordDialog : DXWindow
        {
            ...
            {
                CurrentPasswordValid = CartoonGlobals.PasswordRegex.IsMatch(CurrentPasswordTextBox.TextBox.Text);
            ...
            {
                NewPassword1Valid = !string.IsNullOrEmpty(NewPassword1TextBox.TextBox.Text) && CartoonGlobals.PasswordRegex.IsMatch(NewPassword1TextBox.TextBox.Text);
