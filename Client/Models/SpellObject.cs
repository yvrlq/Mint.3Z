    ...
    public sealed class SpellObject : MapObject
    {
        ...
        public void UpdateLibraries()
        {
            ...
            switch (Effect)
            {
                ...
                case SpellEffect.LightningWall:
                    CEnvir.LibraryList.TryGetValue(LibraryFile.MagicEx10, out BodyLibrary);
                    Frames[MirAnimation.Standing] = new Frame(90, 13, 0, TimeSpan.FromMilliseconds(150));
                    Blended = true;
                    LightColour = Color.Azure;
                    BlendRate = 0.8f;
                    Light = 15;
                    break;
                case SpellEffect.Tempest:
                    ...
                    Blended = true;
                    LightColour = CartoonGlobals.WindColour;
                    BlendRate = 0.55f;
                    Light = 15;
                    break;
                ...
                case SpellEffect.LingshanPoisonousCloud:
                    ...
                    Frames[MirAnimation.Standing] = new Frame(3020, 15, 0, TimeSpan.FromMilliseconds(200));
                ...
                case SpellEffect.JunhengPoisonousCloud:
                    ...
                    DefaultColour = Color.Chartreuse;
                    Blended = true;
                    Light = 0;
                    DXSoundManager.Play(SoundIndex.PoisonousCloudStart);
                    break;
                ...
                case SpellEffect.HuoliMassHeal:
                    CEnvir.LibraryList.TryGetValue(LibraryFile.MagicEx4, out BodyLibrary);
                    Frames[MirAnimation.Standing] = new Frame(3040, 12, 0, TimeSpan.FromMilliseconds(100));
        ...
        public override void OnRemoved()
        {
            ...
            {
                case SpellEffect.SwordOfVengeance:
                    new MirEffect(1100, 10, TimeSpan.FromMilliseconds(100), LibraryFile.MagicEx6, 10, 35, CartoonGlobals.FireColour)
                    {
                        Blend = true,
