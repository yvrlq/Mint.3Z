...
/*
    ...
    public class DamageInfo
    {
        ...
        public bool OneKill
        {
            ...
            set
            {
                if (_OneKill == value) return;

                bool oldValue = _OneKill;
                _OneKill = value;

                OnOneKillChanged(oldValue, value);
            }
        }
        private bool _OneKill;
        public event EventHandler<EventArgs> OneKillChanged;
        public virtual void OnOneKillChanged(bool oValue, bool nValue)
        {
            OneKillChanged?.Invoke(this, EventArgs.Empty);
        }
        ...
        public void Draw(int drawX, int drawY)
        {
            ...
            else
            {
                ...
                if (OneKill && Value < 0)
                {
                    size = Library.GetSize(123);
                    drawX -= size.Width / 2;

                    Library.Draw(123, drawX, drawY, Color.White, false, Opacity, ImageType.Image);
                    drawX += size.Width + 5;
                }
