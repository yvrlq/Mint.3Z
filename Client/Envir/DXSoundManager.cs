...
namespace Client.Envir
{
    public static class DXSoundManager
    {
        ...
        public static Dictionary<SoundIndex, DXSound> SoundList = new Dictionary<SoundIndex, DXSound>
        {
            ...
            [SoundIndex.CrazedPrimateAttack] = new DXSound(SoundPath + @"402-2.wav", SoundType.Monster),
            [SoundIndex.CrazedPrimateStruck] = new DXSound(SoundPath + @"402-4.wav", SoundType.Monster),
            [SoundIndex.CrazedPrimateDie] = new DXSound(SoundPath + @"402-5.wav", SoundType.Monster),
            ...
            [SoundIndex.HellBringerStruck] = new DXSound(SoundPath + @"386-4.wav", SoundType.Monster),
            [SoundIndex.HellBringerDie] = new DXSound(SoundPath + @"386-5.wav", SoundType.Monster),

            [SoundIndex.YurinHoundAttack] = new DXSound(SoundPath + @"393-2.wav", SoundType.Monster),
            [SoundIndex.YurinHoundStruck] = new DXSound(SoundPath + @"393-4.wav", SoundType.Monster),
            [SoundIndex.YurinHoundDie] = new DXSound(SoundPath + @"393-5.wav", SoundType.Monster),

            [SoundIndex.YurinTigerAttack] = new DXSound(SoundPath + @"382-2.wav", SoundType.Monster),
            [SoundIndex.YurinTigerStruck] = new DXSound(SoundPath + @"382-4.wav", SoundType.Monster),
            [SoundIndex.YurinTigerDie] = new DXSound(SoundPath + @"382-5.wav", SoundType.Monster),


            [SoundIndex.HardenedRhinoAttack] = new DXSound(SoundPath + @"347-2.wav", SoundType.Monster),
            [SoundIndex.HardenedRhinoStruck] = new DXSound(SoundPath + @"347-4.wav", SoundType.Monster),
            [SoundIndex.HardenedRhinoDie] = new DXSound(SoundPath + @"347-5.wav", SoundType.Monster),

            [SoundIndex.MammothAttack] = new DXSound(SoundPath + @"398-2.wav", SoundType.Monster),
            [SoundIndex.MammothStruck] = new DXSound(SoundPath + @"398-4.wav", SoundType.Monster),
            [SoundIndex.MammothDie] = new DXSound(SoundPath + @"398-5.wav", SoundType.Monster),
            ...
            [SoundIndex.CursedSlave1Struck] = new DXSound(SoundPath + @"341-2.wav", SoundType.Monster),
            [SoundIndex.CursedSlave1Die] = new DXSound(SoundPath + @"341-5.wav", SoundType.Monster),

            [SoundIndex.CursedSlave2Attack] = new DXSound(SoundPath + @"341-8.wav", SoundType.Monster),
            [SoundIndex.CursedSlave2Struck] = new DXSound(SoundPath + @"341-4.wav", SoundType.Monster),
            [SoundIndex.CursedSlave2Die] = new DXSound(SoundPath + @"341-5.wav", SoundType.Monster),
            ...
            [SoundIndex.CursedSlave3Struck] = new DXSound(SoundPath + @"372-4.wav", SoundType.Monster),
            [SoundIndex.CursedSlave3Die] = new DXSound(SoundPath + @"372-5.wav", SoundType.Monster),
            ...
            [SoundIndex.PoisonousGolemStruck] = new DXSound(SoundPath + @"371-4.wav", SoundType.Monster),
            [SoundIndex.PoisonousGolemDie] = new DXSound(SoundPath + @"371-5.wav", SoundType.Monster),
            ...
            [SoundIndex.WolongbianfuAttack] = new DXSound(SoundPath + @"3882.wav", SoundType.Monster),
            [SoundIndex.WolongbianfuAttack2] = new DXSound(SoundPath + @"3888.wav", SoundType.Monster),
            [SoundIndex.WolongbianfuStruck] = new DXSound(SoundPath + @"371-4.wav", SoundType.Monster),
            [SoundIndex.WolongbianfuDie] = new DXSound(SoundPath + @"371-5.wav", SoundType.Monster),

            
            [SoundIndex.OmaKingAttack] = new DXSound(SoundPath + @"38088.wav", SoundType.Monster),
            [SoundIndex.OmaKingAttack2] = new DXSound(SoundPath + @"38089.wav", SoundType.Monster),
            [SoundIndex.OmaKingStruck] = new DXSound(SoundPath + @"38090.wav", SoundType.Monster),
            [SoundIndex.OmaKingDie] = new DXSound(SoundPath + @"38091.wav", SoundType.Monster),

            
            [SoundIndex.WuguiAttack] = new DXSound(SoundPath + @"37088.wav", SoundType.Monster),
            [SoundIndex.WuguiAttack2] = new DXSound(SoundPath + @"37089.wav", SoundType.Monster),
            [SoundIndex.WuguiStruck] = new DXSound(SoundPath + @"37090.wav", SoundType.Monster),
            [SoundIndex.WuguiDie] = new DXSound(SoundPath + @"37091.wav", SoundType.Monster),
            #endregion
        };
