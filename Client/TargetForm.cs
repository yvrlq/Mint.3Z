...
namespace Client
{
    public sealed class TargetForm : RenderForm
    {
        ...
        public TargetForm() : base("欢乐世界传奇3特色独家铭文版Zircon公益服（技术QQ：15114424，玩家群：124385013） 登录时间:" + Time.Now)
        {
        ...
        public Bitmap GetImage()
        {
            ...
            if (hBmp != IntPtr.Zero)
            {
                ...
                BitBlt(destDc, 0, 0, r.Width, r.Height, sourceDc, r.X, r.Y, 0xCC0020); 
        ...
        private void InitializeComponent()
        {
            ...
            Name = "TargetForm";
            Load += new System.EventHandler(TargetForm_Load);
            ResumeLayout(false);
