...
namespace Server.Envir.Translations
{
    ...
    public class EnglishMessages : StringMessages
    {
        ...
        public override string Welcome { get; set; } = "Welcome to 欢乐世界客服.";
        ...
        public override string Xinjuesetishi { get; set; } = "You are now Observing {0}, to stop, please logout.";
        public override string Wanjiashangxiantishi { get; set; } = "You are now Observing {0}, to stop, please logout.";
        public override string Wanjiaxiaxiantishi { get; set; } = "You are now Observing {0}, to stop, please logout.";
        ...
        public override string GiveItem { get; set; } = "You require a '{0}' to proceed.";
        ...
        public override string MovementGroupOK { get; set; } = "过图失败，你要去的地图时组队才能过去的地图";
        public override string MovementGroup { get; set; } = "过图失败，你不是组队队长";
        public override string MovementGroupDuizhanghuiqu { get; set; } = "进去失败，你的组队队长 {0} 不在副本地图里，把他退出队伍后再继续副本";
        public override string GroupNearby { get; set; } = "你和其他组队成员离得太远了，等他们跟上吧";
        public override string MovementGeren { get; set; } = "过图失败，你有组队，请退出组队后再过地图";
        ...
        public override string YaotaOpen { get; set; } = "通往妖塔副本石门开启，地图：{0}，坐标：{1}";
        public override string YaotaClosed { get; set; } = "通往妖塔副本石门关闭";
        public override string MotaOpen { get; set; } = "通往魔塔副本石门开启，地图：{0}，坐标：{1}";
        public override string MotaClosed { get; set; } = "通往魔塔副本石门关闭";
        public override string Huodong01Open { get; set; } = "通往活动01副本石门开启，地图：{0}，坐标：{1}";
        public override string Huodong01Closed { get; set; } = "通往活动01副本石门关闭";
        public override string Huodong02Open { get; set; } = "通往活动02副本石门开启，地图：{0}，坐标：{1}";
        public override string Huodong02Closed { get; set; } = "通往活动02副本石门关闭";
        ...
        public override string Huodong11Open { get; set; } = "通往活动11副本石门开启，地图：{0}，坐标：{1}";
        public override string Huodong11Closed { get; set; } = "通往活动11副本石门关闭";
        public override string Huodong12Open { get; set; } = "通往活动12副本石门开启，地图：{0}，坐标：{1}";
        public override string Huodong12Closed { get; set; } = "通往活动12副本石门关闭";
        ...
        public override string PatchGridLimit { get; set; } = "You cannot expand the debris package anymore.";
        public override string BaoshiGridLimit { get; set; } = "You cannot expand the debris package anymore.";
        public override string NotCanStorage { get; set; } = "You cannot access storage outside of SafeZone.";
        ...
        public override string GuildWarDate { get; set; } = "最近的沙巴克攻城时间是 {0} ";
        ...
        public override string FubenMapNoGroupInvite { get; set; } = "{0} 在副本地图，不允许加入组队";
        ...
        public override string NPCShengwang { get; set; } = "Unable to buy items, Your Guild needs another {0:#,##0} Gold.";
        ...
        public override string NPCJyChangeWorthless { get; set; } = "Unable to sell items that are worthless";
        public override string NPCJyChangeResult { get; set; } = "You sold {0} item(s) for {1:#,##0} Gold.";
        ...
        public override string Referralshezhicheng { get; set; } = " {0}  {1} ";
    }
}
