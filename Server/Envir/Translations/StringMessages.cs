...
namespace Server.Envir
{
    ...
    public abstract class StringMessages
    {
        ...
        public abstract string Zengjiaswd { get; set; }
        public abstract string kouchuswd { get; set; }
        public abstract string Zengjiazanzhujilu { get; set; }
        public abstract string Jianshaozanzhujilu { get; set; }
        public abstract string Chakanzanzhujilu { get; set; }
        public abstract string zanzhujilu { get; set; }
        ...
        public abstract string Xinjuesetishi { get; set; }
        public abstract string Wanjiashangxiantishi { get; set; }
        public abstract string Wanjiaxiaxiantishi { get; set; }
        public abstract string ClassChangeSafeZone { get; set; }
        ...
        public abstract string GiveItem { get; set; }
        public abstract string MonsterSpawn { get; set; }
        public abstract string CurrentMapBoos { get; set; }
        public abstract string CurrentMapMon { get; set; }
        public abstract string UserTeleportNeedItem { get; set; }
        public abstract string MovementGroupOK { get; set; }
        public abstract string MovementGroup { get; set; }
        public abstract string MovementGroupDuizhanghuiqu { get; set; }
        public abstract string GroupNearby { get; set; }
        public abstract string MovementGeren { get; set; }
        public abstract string Shijianbufu { get; set; }
        ...
        public abstract string YaotaOpen { get; set; }
        public abstract string YaotaClosed { get; set; }
        public abstract string MotaOpen { get; set; }
        public abstract string MotaClosed { get; set; }
        public abstract string Huodong01Open { get; set; }
        public abstract string Huodong01Closed { get; set; }
        public abstract string Huodong02Open { get; set; }
        public abstract string Huodong02Closed { get; set; }
        public abstract string Huodong03Open { get; set; }
        public abstract string Huodong03Closed { get; set; }
        public abstract string Huodong04Open { get; set; }
        public abstract string Huodong04Closed { get; set; }
        public abstract string Huodong05Open { get; set; }
        public abstract string Huodong05Closed { get; set; }
        public abstract string Huodong06Open { get; set; }
        public abstract string Huodong06Closed { get; set; }
        public abstract string Huodong07Open { get; set; }
        public abstract string Huodong07Closed { get; set; }
        public abstract string Huodong08Open { get; set; }
        public abstract string Huodong08Closed { get; set; }
        public abstract string Huodong09Open { get; set; }
        public abstract string Huodong09Closed { get; set; }
        public abstract string Huodong10Open { get; set; }
        public abstract string Huodong10Closed { get; set; }
        public abstract string Huodong11Open { get; set; }
        public abstract string Huodong11Closed { get; set; }
        public abstract string Huodong12Open { get; set; }
        public abstract string Huodong12Closed { get; set; }
        ...
        public abstract string CannotTownAlive { get; set; }
        public abstract string CannotTownPotion { get; set; }
        public abstract string CannotTownHP { get; set; }
        public abstract string CannotTownMP { get; set; }
        public abstract string PatchGridLimit { get; set; }
        public abstract string BaoshiGridLimit { get; set; }
        public abstract string NotCanStorage { get; set; }
        public abstract string NotCastleOwner { get; set; }
        public abstract string CannotCastleTeleport { get; set; }
        public abstract string CannotTownJiedu { get; set; }
        public abstract string SuipianHecheng { get; set; }
        ...
        public abstract string MoveTeleportDead { get; set; }
        public abstract string MoveTeleportPK { get; set; }
        public abstract string MoveTeleportDelay { get; set; }
        ...
        public abstract string MailMailMaxCost { get; set; }
        ...
        public abstract string MarketPlaceBuyMaxGold { get; set; }
        ...
        public abstract string GuildMaxGold { get; set; }
        public abstract string GuildWarDate { get; set; }
        ...
        public abstract string FubenMapNoGroup { get; set; }
        public abstract string FubenMapNoGroupInvite { get; set; }
        ...
        public abstract string TradeMaxGold { get; set; }
        public abstract string TradePartnerMaxGold { get; set; }
        ...
        public abstract string NPCShengwang { get; set; }
        ...
        public abstract string NPCJyChangeWorthless { get; set; }
        public abstract string NPCJyChangeResult { get; set; }
        public abstract string GuildJyChangeWorthless { get; set; }
        public abstract string GuildJyChangeResult { get; set; }
        public abstract string NPCItemAmount { get; set; }
        public abstract string NPCRefinementShengwang { get; set; }
        public abstract string BaoshiHechengSpace { get; set; }
        public abstract string BaoshiFenjieResult { get; set; }
        public abstract string MingwenLevelGold { get; set; }
        ...
        [ConfigSection("Skills")]
        public abstract string Referralshezhicheng { get; set; }
