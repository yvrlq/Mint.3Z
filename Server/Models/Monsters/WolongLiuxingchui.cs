...
{
    public class WolongLiuxingchui : MonsterObject
    {
        public DateTime FearTime;

        public int AttackRange = 5;
        public int FearRate = 4;
        ...
        public override void ProcessTarget()
        {
            ...
            if (!InAttackRange())
            {
                ...
                {
                    direction = (MirDirection) SEnvir.Random.Next(6);
        ...
        protected override void Attack()
        {
            ...
            ActionList.Add(new DelayedAction(
                               SEnvir.Now.AddMilliseconds(400 + Functions.Distance(CurrentLocation, Target.CurrentLocation) * CartoonGlobals.ProjectileSpeed),
