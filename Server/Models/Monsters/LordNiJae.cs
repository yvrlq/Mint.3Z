...
namespace Server.Models.Monsters
{
    public class LordNiJae : CarnivorousPlant
    {
        ...
        {
            return CurrentMap == Target.CurrentMap && Functions.InRange(CurrentLocation, Target.CurrentLocation, CartoonGlobals.MagicRange);
        }
        ...
        protected override void Attack()
        {
            ...
            List<MapObject> targets = GetTargets(CurrentMap, CurrentLocation, CartoonGlobals.MagicRange);
